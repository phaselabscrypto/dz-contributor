...
| [data-sources.md](./data-sources.md) | Every upstream feed in detail (malbec, the economic hub, Foundation S3 snapshots and exports, the fees CSV, Jupiter prices, Solana and DZ-ledger RPC) with URLs, cadences, consuming routes, and failure semantics. |
