...
import { cachedTracking, useShapleyTracking } from "@/lib/hooks/use-live";
  ...
  return (
    <div className="border border-border bg-surface">
      ...
      <div className="border-t border-border px-4 py-3 text-xs text-cream-30 font-mono leading-relaxed">
        Canonical Rust-solver share trajectories across the cached baselines of
        the latest {count} epochs. Epochs the cron has not published are listed,
        not substituted.
      </div>
    </div>
  );
