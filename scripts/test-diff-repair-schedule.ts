...
assert.deepEqual(scheduleDiffRepairs([181, 182, 183, 211], 211, 3, 0), {
  selected: [211, 183, 181],
  deferred: [182],
});
assert.deepEqual(scheduleDiffRepairs([181, 182, 183, 211], 211, 3, 1), {
  selected: [211, 183, 182],
  deferred: [181],
});
assert.deepEqual(scheduleDiffRepairs([], 211, 3, 0), {
  selected: [],
  deferred: [],
});
assert.deepEqual(scheduleDiffRepairs([211, 211, 210], 211, 0, 0), {
  selected: [],
  deferred: [210, 211],
});
